#通过kmeans对文本聚类，先找到最合适的k,由此通过kemans给文本打上k个不同的标签
#之后机器学习算法学习标签，由此输入一个文本，准确预测它属于哪类
...
true_k=d.index(min(d))+1

true_k=2#对于这个明确有两类的数据集，就直接指定有2个聚类中心
